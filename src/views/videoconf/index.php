...
<div class="videoconf-index">
    ...
    <p>
        <?php
        /*echo Html::a(AmosVideoconference::t('amosvideoconference', 'Nuova videoconferenza istantanea', [
    ...
    echo DataProviderView::widget([
        ...
        'gridView' => [
            ...
            'columns' => [
                ...
                //'status',
                //['attribute' => 'begin_date_hour', 'format' => ['datetime', (isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']],
                    ...
                    'buttons' => [
                        'join' => function ($url, $model) {
                            if($model->isVideoConferenceRoomActive()) {
                                ...
                                return Html::a(AmosIcons::show('videocam', ['class' => 'btn btn-tool-secondary']), $action,
                                    $options);
                            }
                        },
